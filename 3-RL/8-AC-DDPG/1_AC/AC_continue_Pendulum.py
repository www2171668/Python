...
class Actor():
    def __init__(self, sess, n_features, action_bound, lr=0.0001):
        ...
        # 因为输入的图像比较简单，所以使用全连接神经网络就足够了
        l1 = tf.layers.dense(   # 相当于Φ(s,a) * w
            inputs=self.s,
        ...
        with tf.name_scope('exp_v'):
            log_prob = self.normal_dist.log_prob(self.a)  # loss without advantage   log_prob:策略概率的对数
...
OUTPUT_GRAPH = False
MAX_EPISODE = 1000   # 总迭代次数
MAX_EP_STEPS = 200   # 单次迭代最大步数
